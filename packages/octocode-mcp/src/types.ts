...
/**
 * Bitbucket Data Center configuration for connecting to on-prem instances.
 */
export interface BitbucketConfig {
  /** Bitbucket Data Center host URL */
  host: string | undefined;
  /** Bitbucket API token */
  token: string | null;
  /** Source of the Bitbucket token */
  tokenSource: BitbucketTokenSourceType;
  /** Whether Bitbucket is configured (has valid token and host) */
  isConfigured: boolean;
}
